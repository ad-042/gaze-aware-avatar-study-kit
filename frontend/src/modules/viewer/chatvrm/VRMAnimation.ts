/**
 * Holds parsed VRM animation data and creates Three.js AnimationClips
 * targeting a specific VRM instance.
 *
 * Ported from pixiv/ChatVRM.
 * Original: src/lib/VRMAnimation/VRMAnimation.ts
 *
    ...
    for (const [name, origTrack] of this.humanoidTracks.rotation.entries()) {
      ...
      if (nodeName != null) {
        const track = new THREE.VectorKeyframeTrack(
          ...
          origTrack.times as unknown as number[],
